...
<div class="atshowa">
				...
				<div align="center" style="font-family:'微软雅黑'; color:#000">
				  <p><%
Command1.CommandText = "update student.applythree set 学籍所在地 = '"&request.Form("xj")&"',提交 = 1,接受单位名称 = '"&request.Form("dw")&"',户口是否在校 = '"&request.Form("hk")&"',双选会 = '"&request.Form("sxh")&"',协议返回情况='"&request.Form("xy")&"' where 学号 = '"&request.Form("sno")&"'"
					Command1.Execute()
				  %>处理成功，点击下方按钮返回。</p>
				  <p >
				    <a href="applyinf.asp?sno=<%=request.Form("sno")%>"><input type="button" name="get" id="get" value="返回" style="font-size: 16px;
