...
Command111.CommandText = "INSERT INTO 留言 (账号,IP, 类型, 时间)  VALUES ('"& session("MM_username") & "',' "  & request.servervariables("remote_addr")  & "','informationmobile','" & year(Now) & "-" & Month(Now) & "-" & day(Now) & " " & Hour(Now) & ":" & Minute(Now) & ":" & Second(Now) & "' ) "
		...
		<div class="header">
          ...
          <div class="logo-right">
				...
				<ul class="nav1">
					...
					<li class="cap"><a href="#" class="act1">个人信息</a></li>
     ...
     <tr>                  <!-- 奇数行 -->  
      ...
      <tr>                  <!-- 奇数行 -->  
        ...
        <td><%=(Recordset1.Fields.Item("培养方向").Value)%></td>  
                  ...
                  <div align="center" style="left:40%">
                   <p align="center">&nbsp;</p>
  <p align="center"></p>
  <p align="center" style="border-bottom:2px dashed #000; border-top:2px dashed #000">注意：信息修改权限此时并未开放，若有问题请联系管理员。</p>
  </div>
<p align="center"></p>
  <p align="center">&nbsp;</p>
          </div>
