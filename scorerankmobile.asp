...
Command111.CommandText = "INSERT INTO 留言 (账号,IP, 类型, 时间)  VALUES ('"& session("MM_username") & "',' "  & request.servervariables("remote_addr")  & "','scorerankmobile','" & year(Now) & "-" & Month(Now) & "-" & day(Now) & " " & Hour(Now) & ":" & Minute(Now) & ":" & Second(Now) & "' ) "
		...
		<div class="header">
          ...
          <div class="logo-right">
				...
				<ul class="nav1">
					...
					<li><a href="ttinformation.asp" class="act1">个人信息</a></li>
					<li><a href="ttnoticemobile.asp" class="act2">通知信息</a></li>
					<li class="cap"><a href="#" class="act3">成绩相关</a></li>
...
<div class="submit" style="max-width:400px"><input type="submit" style="border-color:#111; background:#3d279a;color:#FFF; border-style:solid" onClick="window.location=('scorecontentmobile.asp');" value="成绩信息"><input type="submit" style="border-color:#E7E7E7; background:#E7E7E7; border-style:solid" value="排名证明" ></div>
