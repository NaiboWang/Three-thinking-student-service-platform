...
<div class="atshowa">
				...
				<div align="center" style="font-family:'微软雅黑'; color:#000">
				  <p><%
					...
					Command1.CommandText  = "update student.applyend set state = '已处理' where sno = '"& request.Form("sno") &"' and type = '"&request.Form("type") &"'" 
					Command1.Execute()
				  if request.Form("type") = "协议返回" then
				  	Command1.CommandText  = "update student.applythree set 协议返回情况 = '已返回' where 学号 = '"& request.Form("sno") &"'"
					Command1.Execute()
				  end if
				  %>处理成功，点击下方按钮返回。</p>
				  <p >
				    <a href="applydeal.asp"><input type="button" name="get" id="get" value="返回" style="font-size: 16px;
