...
Command111.CommandText = "INSERT INTO 留言 (账号,IP, 类型, 时间)  VALUES ('"& session("MM_username") & "',' "  & request.servervariables("remote_addr")  & "','scoreindexmobile','" & year(Now) & "-" & Month(Now) & "-" & day(Now) & " " & Hour(Now) & ":" & Minute(Now) & ":" & Second(Now) & "' ) "
...
<!-- header -->
		<div class="header">
          ...
          <div class="logo-right">
				...
				<ul class="nav1">
					<li class="cap"><a href="" class="act">主页</a></li>
...
<div class="port"  style="font:'楷体'">
  <h3>欢迎使用！</h3>
		...
		<% If Not Recordset3.EOF Or Not Recordset3.BOF Then %>
         ...
         <p class="para" style="color:#90F"> ★您近期有统计信息需要统计，点击<strong><a href="scoredocumentmobile.asp">事务管理-&gt;班级事务</a></strong>进行统计。</p>
  ...
  <img src="hr-geo-sukarno-1s960x639.png"  style="  position:relative; left:2%;background-size:cover; background-position:center; width:90%;height:90%" alt=""/>
		<div class="portfolio-grids">
			     <div class="view view-ninth" style="width:100%">
			       <table align="center" style="border-bottom:2px dotted #000">
			         <tr>
			           <td height="210"><h3 align="center" style=" border-bottom:2px dotted #000; ">导航信息</h3>
			             <p>三思系统升级说明：<br>
			               ★“<strong>成绩信息</strong>”、“<strong>成绩预测</strong>”、“<strong>排名证明</strong>”被放到了“成绩相关”中。<br>
			               ★新添加“<strong>通知信息</strong>”模块，包含个人信息、班级信息和公共信息。<br>
			               ★新添加“<strong>留言</strong>”、“<strong>修改密码</strong>”模块，在“系统相关”中。 </p></td>
		             </tr>
		           </table>
