...
Recordset2_cmd.CommandText = "SELECT * FROM student.informa where ID = "& request.QueryString("ID") 
...
Command1.CommandText = "UPDATE student.informa  SET num = num +1 WHERE ID =  "& request.QueryString("ID") 
Command1.CommandType = 1
Command1.CommandTimeout = 0
Command1.Prepared = true
sessionnews = "sessioninfor" &  request.QueryString("ID") 
...
<html>
<head>
<title><%=(Recordset2.Fields.Item("title").Value)%>--三思·通知信息</title>
...
<div class="typrography">
     ...
     <p  align="center" class = "tzxx" style="display:none; font-size:30px ">最新通知信息</p>
		<img class="tzxx" src="images/textinfor.png" style="background-position:center;left:35%;position:relative;background-size:cover; min-height:50px; min-width:200px; width:30%;height:30%"  longdesc="news.asp">
	   <div class="clearfix"> </div>
	</div>
	<div class="container">
			 <div class="grid_3 grid_5" >
				 
                 <div id="wz" style="padding-left:5%"><b>您的位置：</b><a href="index.asp" style="color:blue">三思主页</a>&nbsp;&gt;&nbsp;<a href="inforlist.asp" style="color:blue">最新通知</a>&nbsp;&gt;&nbsp;</div>
...
.atshowcontent img
{
	max-width:100%;
               ...
               <%=(Recordset2.Fields.Item("content").Value)%>
				...
				<p style="margin-left: 24pt;text-align:right; font-family:'微软雅黑'; font-size:18px;color:black">三思团队				</p></span>			
				</span></div>
					</div>
                           <script>
　　var browser = {
